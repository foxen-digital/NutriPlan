    ...
    <form @submit.prevent="submit" class="space-y-8">
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2 combobox-with-create">
                    <ComboboxWithCreate :model-value="0" :options="availableCategories"
                        placeholder="Search for categories..." :allow-create="true" create-endpoint="/categories"
                        @update:model-value="addCategory" @option-created="handleNewCategory" />
                </div>
